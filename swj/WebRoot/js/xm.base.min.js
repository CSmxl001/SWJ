...
var b={path:"/",domain:".xiaomi.com"};a.UI.cookie("XM_"+this.miid+"_UN",this.data.userName,b);this.upNavigationHtml();}}},xmFocus:{init:function(e,b){var h=this;
var g=e.find("img");$.each(g,function(j,i){if(g[j].complete){$(this).parent().css({display:"block"});}else{g[j].onload=function(){$(this).parent().css({display:"block"});
...
c++){$('<li class="slideshow-bt" index="'+(this.mlength-c)+'"></li>').appendTo(this.ul);}this.ul.find(".slideshow-bt:last").addClass("on");this.ul.find(".slideshow-bt").mouseenter(function(i){h.slideTo(this);
});var d=true;this._obj.mouseenter(function(){d=false;}).mouseleave(function(){d=true;});var f=h.mtime1;setInterval(function(){if(d){h.slideDown();}},f);
